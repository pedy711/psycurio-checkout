...
namespace PsyCurio.Shop
{
    ...
    /// Assets/Items; a non-programmer adds items via Create > PsyCurio > Shop
    /// Item and reprices them here without touching code. The asset's file
    /// name doubles as the stable item id.
    /// </summary>
